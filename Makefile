...
SOURCES = main.c mzapo_phys.c mzapo_parlcd.c serialize_lock.c lcd_chars.c utils.c
SOURCES += font_prop14x16.c font_rom8x16.c controllers.c figures.c game.c menu.c game_mechanics.c
TARGET_EXE = main
#TARGET_IP ?= 192.168.223.201
ifeq ($(TARGET_IP),)
ifneq ($(filter debug run,$(MAKECMDGOALS)),)
$(warning The target IP address is not set)
$(warning Run as "TARGET_IP=192.168.223.xxx make run" or modify Makefile)
TARGET_IP ?= 192.168.223.203
endif
endif
